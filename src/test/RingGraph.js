let ZOOM_LIMITS = { min: 0.2, max: 2, inStep: 1.2, outStep: 0.8 }
let COMPLETED_ICON_SVG = `<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20.000000" height="20.000000" fill="none">
...
let encodeSvg = svg => `image://data:image/svg+xml;utf8,${encodeURIComponent(svg)}`
let encodeSvgData = svg => `data:image/svg+xml;utf8,${encodeURIComponent(svg)}`
          ...
          case 'xlsx':
              ...
              this.commonsJs.Axios({
                  ...
                  headers: {
                      ...
                      RoleCode: _this.info && _this.info.jsdm ? _this.info.jsdm : ''
                  },
                  responseType: 'blob'
              })
                  .then(res => {
