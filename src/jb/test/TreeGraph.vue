...
export default {
    ...
    methods: {
            ...
            const convertNode = (node, depth = 0, rootBranchIndex = 0) => {
                ...
                const baseNode = {
                    ...
                    children: (node.children || [])
                        // .filter(child => Number(child.lmlx) !== 3) // 过滤资源节点，不展示在导图中
                        .map((child, index) => {
        ...
        buildNodeTopic(node, options = {}) {
            ...
            if (Number(node && node.lmlx) == 1 || Number(node && node.lmlx) == 0) {
            ...
            if (this.isLeaf(node)) {
                ...
                return `<div class="tg-node-content tg-node-content--knowledge">
                        <div class="tg-node-title"${styleAttr}>
                            ...
                            ${this.yhlx == 'student' && node.zjjd == 100 ? zsdzt : ''}
                        </div>
